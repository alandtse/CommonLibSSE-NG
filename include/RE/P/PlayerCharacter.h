...
#define VR_PLAYER_RUNTIME_DATA_CONTENT                                                                                                                                                                                                                                        \
	...
	std::uint64_t      unk8B0[0x22];                                                                  /* 8B0 - 272 bytes; misc VR state. VR PC ctor inits: +0x00 = -1 handle, +0x08 = -inf timestamp (0xff7fffff), +0x0C = 25.0f (0x41c80000), 2 NiPoint3 at +0xE0/+0xEC */   \
	...
	std::uint64_t          unk1240[0x11];                                                             /* 1240 - 136 bytes (17 uint64); VR PC ctor pattern shows 2 iterations of ~64-byte sub-struct (handle@+0, BSTArrayHeapAllocator@+8, uint32@+0x18, ...) + 8-byte tail */ \
