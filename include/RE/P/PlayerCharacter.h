...
#define VR_PLAYER_RUNTIME_DATA_CONTENT                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               \
	...
	std::uint8_t       unk8B0[0x28];                                                                  /* 8B0 - ctor sentinels/floats; includes cached character Z rotation @+0x14 (abs 8C4), gamepad-heading-smoothing gate @+0x18 (abs 8C8) -- not cleanly separable without fresh ctor disasm */                                                                                                                                                                                                                                   \
