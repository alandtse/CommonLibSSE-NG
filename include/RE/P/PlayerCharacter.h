...
#define VR_PLAYER_RUNTIME_DATA_CONTENT                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               \
	...
	std::uint64_t             unk1240;               /* 1240 - scalar preceding the perk entry-point cache struct; not yet characterized */                                                                                                                                                                                                                                                                                                                                                                                          \
	std::uint8_t              unk1248[0x18];         /* 1248 - BSTArray<T*>-shaped container (24 bytes) -- same 2-call BSTArrayHeapAllocator+Zero4Bytes ctor fingerprint as the confirmed tintMasks field; element type T unconfirmed */                                                                                                                                                                                                                                                                                             \
	std::uint8_t              unk1260[0x28];         /* 1260 - gap between unk1248's array and alchemyEntryPoint/temperingEntryPoint; not yet characterized */                                                                                                                                                                                                                                                                                                                                                                       \
	...
	std::uint8_t              unk1298[0x30];         /* 1298 - tail of the perk entry-point cache region (0x1298-0x12C8); BSTSmallArray-shaped ctor fingerprint (0x80000000 inline-capacity sentinel + Zero4Bytes), same pattern as VRPlayerHandData's small containers; element type/exact sub-layout unconfirmed */                                                                                                                                                                                                                \
