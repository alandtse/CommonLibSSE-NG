...
#define VR_PLAYER_RUNTIME_DATA_CONTENT                                                                                                                                                                                                                                                                                                                                                                                                                                  \
	...
	std::uint64_t      unk6F0[0x3];                                                                   /* 6F0 - 24 bytes (corrected from a stale [0x4]/32-byte declaration -- the 4th element didn't exist; it was shifting hands/unk8B0/questTargetsLock 8 bytes late). VR PC ctor writes 6 consecutive floats with NiPoint3-component init values — likely 2 NiPoint3 */                                                                                             \
