...
#define VR_PLAYER_RUNTIME_DATA_CONTENT                                                                                                                                                                                                                                                                                                                                                                                                                                                      \
	...
	std::uint64_t      unk8B0[0x22];                                                                  /* 8B0 - 272 bytes; misc VR state. First 0x94 bytes init via dedicated function (FUN_1405358d0 / VRPlayerViewState_Init): +0x10 = float 75.0 (likely FOV), +0x14 = NiMatrix3 Identity, +0x38 = NiMatrix3 Identity, +0x5C..+0x8B = 4× NiPoint3 — VR stereo view state */                                                                                                            \
