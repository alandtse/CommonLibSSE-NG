...
#define VR_PLAYER_RUNTIME_DATA_CONTENT                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               \
	...
	void*                     alchemyEntryPoint;     /* 1288 - PERK ENTRY POINT CACHE; read by EPAlchemyEffectHasKeyword, which calls a virtual HasKeyword-shaped function (vtable slot 4) on a sub-object at +0x40 -- likely points to a TESForm-derived object (AlchemyItem/MagicItem?) with an embedded BGSKeywordForm-style interface; exact class unconfirmed, not typed further */                                                                                                                                             \
