...
#define VR_PLAYER_RUNTIME_DATA_CONTENT                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               \
	...
	void*                  alchemyEntryPoint;     /* 1288 - PERK ENTRY POINT CACHE; read by EPAlchemyEffectHasKeyword */                                                                                                                                                                                                                                                                                                                                                                                                             \
	void*                  temperingEntryPoint;   /* 1290 - PERK ENTRY POINT CACHE; read by EPTemperingItemHasKeyword/EPTemperingItemIsEnchanted */                                                                                                                                                                                                                                                                                                                                                                                  \
