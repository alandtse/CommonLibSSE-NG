...
#define VR_PLAYER_RUNTIME_DATA_CONTENT                                                                                                                                                                                                                                                                                                                                           \
	...
	std::uint64_t      unk6A8[0x5];                                                                   /* 6A8 - 40 bytes; VR PC ctor inits +0x08 = π (0x40490FDB), +0x0C = byte 1; likely angle/limit struct */                                                                                                                                                                  \
	...
	std::uint64_t      unk6F0[0x4];                                                                   /* 6F0 - 32 bytes; VR PC ctor writes 8 consecutive floats with NiPoint3-component init values — likely 2 NiPoint3 + extras */                                                                                                                                            \
	...
	std::uint64_t          unk1240[0x11];                                                             /* 1240 - 136 bytes (17 uint64); CONFIRMED VR PC ctor calls BSTArrayHeapAllocator::ctor at +0x08 and +0x58 → 2 instances of a ~0x40 sub-struct, each containing { uint32 handle@+0, BSTArrayHeapAllocator@+8, uint32 sentinel@+0x18, ... } + 8-byte tail */              \
