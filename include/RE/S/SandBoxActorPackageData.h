...
namespace RE
{
	...
	public:
		...
		void*           arrayData28;   // 28 - array data ptr, 0x10-byte elements (Func7_140714630 indexes data+i*0x10)
		std::uint32_t   unk30;         // 30
		std::uint32_t   unk34;         // 34
		std::uint32_t   arrayCount38;  // 38 - element count read by Func7_140714630's iteration loop
