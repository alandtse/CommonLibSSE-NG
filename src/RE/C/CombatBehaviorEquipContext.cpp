...
namespace RE
{
	...
	bool CombatBehaviorEquipContext::CanEquipItem() const
	{
		...
		REL::Relocation<func_t> func{ RELOCATION_ID(43628, 0) };
	...
	bool CombatBehaviorEquipContext::CheckEquipmentChanged()
	{
		...
		REL::Relocation<func_t> func{ RELOCATION_ID(46951, 0) };
		return func(this);
	}
	...
	bool CombatBehaviorEquipContext::EquipItem()
	{
		...
		REL::Relocation<func_t> func{ RELOCATION_ID(46952, 0) };
		return func(this);
	}
	...
	NiPointer<CombatInventoryItem> const& CombatBehaviorEquipContext::GetCombatItem() const
	{
		...
		REL::Relocation<func_t> func{ RELOCATION_ID(32458, 0) };
		return func(this);
	}
