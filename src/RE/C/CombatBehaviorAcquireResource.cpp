...
namespace RE
{
	CombatBehaviorAcquireResource::CombatBehaviorAcquireResource()
	{
		...
		REL::Relocation<func_t> func{ RELOCATION_ID(46206, 0) };
		func(this);
	}
	...
	CombatBehaviorAcquireResource::CombatBehaviorAcquireResource(const BSFixedString& name, uint32_t priority, FLAG flags)
	{
		...
		REL::Relocation<func_t> func{ RELOCATION_ID(46207, 0) };
	...
	void CombatBehaviorAcquireResource::Abort()
	{
		...
		REL::Relocation<func_t> func{ RELOCATION_ID(46212, 0) };
		return func(this);
	}
	...
	{
		using func_t = decltype(&CombatBehaviorAcquireResource::Abort);
		REL::Relocation<func_t> func{ RELOCATION_ID(46209, 0) };
		return func(this);
	}
	...
	{
		using func_t = decltype(&CombatBehaviorAcquireResource::Abort);
		REL::Relocation<func_t> func{ RELOCATION_ID(46211, 0) };
		return func(this);
	}
	...
	{
		using func_t = decltype(&CombatBehaviorAcquireResource::Abort);
		REL::Relocation<func_t> func{ RELOCATION_ID(46210, 0) };
		return func(this);
	}
}
